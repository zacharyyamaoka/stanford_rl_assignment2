...
class Linear(DQN):
    ...
    def add_placeholders_op(self):
        ...
        self.s = tf.compat.v1.placeholder(
            tf.uint8, shape=[None, 80, 80, 4], name="states")
        self.a = tf.compat.v1.placeholder(
            tf.uint32, shape=[None], name="actions")
        self.r = tf.compat.v1.placeholder(
            tf.float32, shape=[None], name="rewards")
        self.sp = tf.compat.v1.placeholder(
            tf.uint8, shape=[None, 80, 80, 4], name="next states")
        self.done_mask = tf.compat.v1.placeholder(
            tf.bool, shape=[None], name="done")
        self.done_mask = tf.compat.v1.placeholder(
            tf.float32, shape=[1], name="learning rate")
        ##############################################################
        ######################## END YOUR CODE #######################
